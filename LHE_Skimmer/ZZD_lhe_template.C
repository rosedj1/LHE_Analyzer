...
void ZZD_lhe(TString powhegLheFile = "cmsgrid_final_MG5_MZdZDMASS_15000events_lhaid306000.lhe", long int Nevents = NEVENTS, bool bApplyCuts = FIDUCIAL, unsigned int kDebugLevel = 1) {
// define input
    ifstream in;
