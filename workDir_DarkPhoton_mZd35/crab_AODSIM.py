...
config.JobType.outputFiles                      = ['zd0j_mzd'+zd_mass+'_AODSIM.root',]

#____________________________________________________________||
config.section_("Data")
config.Data.inputDBS                = 'phys03'
config.Data.inputDataset            = '/ZD_UpTo0j_MZD35_Eps1e-2/klo-PUMoriond17-Realistic25ns13TeVEarly2017Collision-93X_mc2017_realistic_v3-PUMix-c6227e979cbe48413af7386c748d1061/USER' 
...
config.Data.outLFNDirBase           = '/store/user/klo/DarkPhoton_Moriond17_AODSIM/'+version+'/'
